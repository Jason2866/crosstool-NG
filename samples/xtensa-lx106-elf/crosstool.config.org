...
CT_GCC_DEVEL_URL="https://github.com/Jason2866/espressif_gcc.git"
CT_GCC_DEVEL_BRANCH="gcc-10"
CT_CC_GCC_ENABLE_CXX_FLAGS="-fno-rtti -ffunction-sections"
CT_CC_GCC_CORE_EXTRA_CONFIG_ARRAY="--enable-threads=posix"
CT_CC_GCC_EXTRA_CONFIG_ARRAY="--target=xtensa-lx106-elf --disable-libstdcxx-verbose --enable-threads=posix --enable-gcov-custom-rtio --disable-shared --with-newlib --enable-threads=no --disable-__cxa_atexit --disable-libgomp --disable-libmudflap --disable-nls --disable-multilib --disable-bootstrap --enable-languages=c,c++ --enable-static=yes"
...
CT_BINUTILS_DEVEL_BRANCH="esp_based_on_binutils-2_35"
